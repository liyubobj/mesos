...
TEST_F(HierarchicalAllocatorTest, UnreservedDRF)
{
  ...
  allocator->addSlave(
      slave1.id(), slave1, None(), slave1.resources(), {}, EMPTYRUNNINGS);
  ...
  allocator->addSlave(
      slave2.id(), slave2, None(), slave2.resources(), {}, EMPTYRUNNINGS);
  ...
  allocator->addSlave(
      slave3.id(), slave3, None(), slave3.resources(), {}, EMPTYRUNNINGS);
  ...
  allocator->addSlave(
      slave4.id(), slave4, None(), slave4.resources(), {}, EMPTYRUNNINGS);
  ...
  allocator->addSlave(
      slave5.id(), slave5, None(), slave5.resources(), {}, EMPTYRUNNINGS);
...
TEST_F(HierarchicalAllocatorTest, MultipleFrameworksInRoleWithQuota)
{
  ...
  allocator->addSlave(
      agent3.id(), agent3, None(), agent3.resources(), {}, EMPTYRUNNINGS);
