...
#ifdef __linux__
  // GPU resource.
  // Delegate the responsibility of enumerating GPUs to the
  // `NvidiaGpuAllocator`. It will parse the flags and return a
  // resource vector containing just the `gpus` resources we should
  // include in our enumeration.
